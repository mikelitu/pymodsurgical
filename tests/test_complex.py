...
class TestComplex(unittest.TestCase):
    def test_tensor_rotate_phase_to_real_axis(self):
        ...
        real_axis = complex.tensor_rotate_phase_to_real_axis(tensor)
    ...
    def test_complex_from_magnitude_phase(self):
        ...
        complex_tensor = complex.complex_from_magnitude_phase(magnitude, phase)
    ...
    def test_complex_to_magnitude_phase(self):
        ...
        magnitude, phase = complex.complex_to_magnitude_phase(complex_tensor)
    ...
    def test_motion_spectrum_2_complex(self):
        ...
        complex_tensor_2d = complex.motion_spectrum_2_complex(motion_spectrum_2d)
        ...
        complex_tensor_3d = complex.motion_spectrum_2_complex(motion_spectrum_3d)
        ...
        with self.assertRaises(ValueError):
            complex.motion_spectrum_2_complex(motion_spectrum_1d)
    ...
    def test_load_save_modal_coordinates(self):
        ...
        # Call the function
        complex.save_modal_coordinates(modal_coordinates, save_dir, displacement, pixel)

        # Check if the file exists
        self.assertTrue(Path(expected_filename).exists())

        # Check that the modal coordinates are the same
        loaded_modal_coordinates = complex.load_modal_coordinates(expected_filename)
    ...
    def test_normalize_modal_coordinate(self):
        ...
        normalized_modal_coordinate = complex.normalize_modal_coordinate(modal_coordinate)
    ...
    def test_plot_modal_coordinates(self):
        ...
        complex.plot_modal_coordinates(modal_coordinates, displacement, pixel, show=False, save=True, save_dir=save_dir)
